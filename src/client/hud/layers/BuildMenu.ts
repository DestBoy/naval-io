...
// naval.io: Submarine icon (reuse warship icon for now, custom art later)
...
// naval.io: Modern warfare (nukes, MIRV, SAMs, missile silos) and trains have
// been removed from the player's build menu. The underlying code still exists
// for now (will be cleaned up in a later refactor), but players can no longer
// build these units. Only naval-relevant structures remain.
...
export class BuildMenu extends LitElement implements Controller {
  ...
  public sendBuildOrUpgrade(buildableUnit: BuildableUnit, tile: TileRef): void {
    if (buildableUnit.canUpgrade !== false) {
      ...
      // naval.io: no rocket weapons, so rocketDirectionUp is always undefined
      this.eventBus.emit(
