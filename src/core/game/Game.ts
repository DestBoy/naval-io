...
// naval.io: Naval ships group (player-buildable, but NOT in attack menu)
export const NavalShips = unitTypeGroup([
  UnitType.Warship,
  UnitType.Submarine,
] as const);
...
export interface UnitParamsMap {
  ...
  // naval.io: Submarine params
  [UnitType.Submarine]: {
    patrolTile: TileRef;
  };

  // naval.io: Torpedo params
  [UnitType.Torpedo]: {
    targetUnit: Unit;
  };
}
