...
export class UnitImpl implements Unit {
  ...
  constructor(
    ...
    // naval.io: initialize submarine state
    if (this._type === UnitType.Submarine) {
      this._submarineState = {
        ...
        depth: 0,
        lastTorpedoTick: -100,
        patrolTile: "patrolTile" in params ? params.patrolTile : undefined,
      };
    }
    this._targetUnit =
    ...
    return {
      ...
      transportShipState:
        this._transportShipState !== undefined
          ...
          : undefined,
      // naval.io: submarine state for client rendering
      submarineState:
  ...
  // naval.io: Submarine state methods
  ...
  updateSubmarineState(update: Partial<SubmarineState>): void {
    ...
    this._submarineState = { ...this._submarineState, ...update };
    this.mg.addUpdate(this.toUpdate());
  }
